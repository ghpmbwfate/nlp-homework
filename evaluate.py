"""
评估脚本：对比 submit.json 与 test_ground_truth.json，计算多项指标
...
if __name__ == "__main__":
    ...
    parser.add_argument("--pred", type=str, default="submit.json", help="预测结果路径")
    parser.add_argument("--gold", type=str, default="test_ground_truth.json", help="标准答案路径")
    parser.add_argument("--output", type=str, default="evaluation_result.json", help="详细结果输出路径")
